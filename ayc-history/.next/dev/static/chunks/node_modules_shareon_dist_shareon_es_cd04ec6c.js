...
"[project]/node_modules/shareon/dist/shareon.es.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    for (const a of t)for (const e of a.children)if (e) {
        ...
        for(let r = 0; r < c; r += 1){
            ...
            if (Object.prototype.hasOwnProperty.call(l, i)) {
                const s = {
                    url: encodeURIComponent(e.dataset.url || a.dataset.url || globalThis.location.href),
...
//# sourceMappingURL=node_modules_shareon_dist_shareon_es_cd04ec6c.js.map